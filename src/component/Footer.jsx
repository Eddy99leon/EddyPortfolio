...
const Footer = () => {
  return (
    <div>
      <div className='flex max-w-5xl w-full justify-between items-center mx-auto py-10 px-3 border-t border-gray-400 dark:border-gray-900'>
      ...
      <div className='text-center font-medium text-gray-950 dark:text-gray-200 border-t border-gray-400 dark:border-gray-900 py-3 transition-all duration-700'>
